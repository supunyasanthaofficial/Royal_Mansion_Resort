      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
        ...
        <div>
          ...
          <div className="text-sm text-gray-600 space-y-2">
            ...
            <a
              href="mailto:info.royalmationresort@gmail.com"
              className="flex items-center hover:text-gray-900 transition-colors lowercase"
            >
        ...
        <div>
          ...
          <div className="text-sm leading-relaxed text-gray-600 flex items-start">
