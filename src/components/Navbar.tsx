  ...
  return (
    <nav
      className="absolute top-0 left-0 w-full z-50 bg-white md:bg-white/5 md:backdrop-blur-sm
                 border-b border-black/10 md:border-white/10 text-black md:text-white"
      aria-label="Main navigation"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base sm:text-lg md:text-xl font-serif font-bold tracking-tight text-black md:text-white/95 leading-none">
                Royal Mansion
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              aria-controls="mobile-menu"
              aria-label={isOpen ? "Close menu" : "Open menu"}
              className="md:hidden p-2 rounded-md text-2xl text-black hover:text-[#f0da60] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#f0da60]"
            >
              {isOpen ? <HiX /> : <HiMenuAlt3 />}
            </button>
          </div>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        className={`md:hidden fixed inset-y-0 left-0 z-40 w-4/5 max-w-xs transition-transform duration-300 ease-in-out
                    bg-white border-r border-black/20 text-black
                    ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="flex flex-col h-full px-6 py-8 overflow-y-auto">
          <nav className="flex flex-col items-start gap-5 grow">
            <Link
              to="/"
              ref={firstLinkRef}
              onClick={closeAndNavigate}
              className="text-black text-lg font-semibold uppercase tracking-widest hover:text-[#f0da60] focus:outline-none focus:ring-2 focus:ring-[#f0da60] px-2"
            >
              Home
            </Link>
            <Link
